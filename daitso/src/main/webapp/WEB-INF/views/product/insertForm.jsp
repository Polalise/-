...
<body>
	<div class="container" align="center">
		...
		<form action="p_insert.do" method="post" name="frm"
			...
			<table class="table table-bordered table-hover">
				<c:if test="${p_num == 0 }">
					<tr>
						<td>제목</td>
						<td><input type="text" name="p_name" required="required" autofocus="autofocus"></td>
					</tr>
				</c:if>
				<c:if test="${p_num != 0 }">
					<tr>
						<td>제목</td>
						<td><input type="text" name="p_name" required="required" autofocus="autofocus" value="답변)"></td>
					</tr>
				</c:if>
		...
		회원게시판은 login하지 않으면 조회하지만 입력/수정/삭제는 불가능 비회원 게시판은 암호를 확하여 맞으면 수정/삭제 가능	 -->
				<tr>
					<td>작성자</td>
					<td><input type="text" name="p_writer" required="required" value="${member.nickName }"></td>
				</tr>
				<tr>
					<td>가격</td>
				...
				<tr>
					<td>지역</td>
					<td><input type="text" name="p_local" required="required"></td>
				</tr>
				<tr>
					<td>판매/구매</td>
				...
				<tr>
					<td>분류</td>
					<td><select id="selbox2" class="selbox2" name="p_tag">
				...
				<tr>
					<td>내용</td>
					<td><textarea rows="5" cols="40" name="p_content" required="required"></textarea></td>
				</tr>
				<tr>
