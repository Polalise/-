					...
					<form action="p_update.do" method="post" id="frm"
						...
						<div class="title">
							<dl>
								<dt>이미지 업로드</dt>
								<dd>
									<label for="file-input1"> <img alt=""
										src="${path }/resources/images/poto.png"
										style="width: 30px; cursor: pointer; margin-left: 10px;">
									</label> <label for="file-input2"> <img alt=""
										src="${path }/resources/images/poto.png"
										style="width: 30px; cursor: pointer;">
									</label> <label for="file-input3"> <img alt=""
										src="${path }/resources/images/poto.png"
										style="width: 30px; cursor: pointer;">
									</label> <label for="file-input4"> <img alt=""
										src="${path }/resources/images/poto.png"
										style="width: 30px; cursor: pointer;">
									</label> <label for="file-input5"> <img alt=""
										src="${path }/resources/images/poto.png"
										style="width: 30px; cursor: pointer;">
