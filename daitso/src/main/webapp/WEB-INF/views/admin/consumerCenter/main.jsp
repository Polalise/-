...
<link rel="stylesheet" type="text/css" href="/test20/resources/main.css">
<meta charset="UTF-8">
...
<button id="b4" onClick="location.href='replyWriteForm.do?rno=0&pageNum=1&num=1'">신고관리</button>
</div>
<div id="g3">
