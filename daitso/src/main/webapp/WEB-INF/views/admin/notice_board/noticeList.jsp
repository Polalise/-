...
<body>
	...
	<div id="total" style=""border-radius: 5px;"">
		...
		<div class="" id="sub" >
			...
			<form action="noticeList.do?pageNum=1" style="margin-bottom: 20px; margin-left: 1350px; margin-top: 50px;">
				<select name="search">
					<c:forTokens var="sh" items="id,subject,content,subcon" delims=","
						varStatus="i">
			...
			<c:if test="${id == 'admin'}">
				<div align="center">
					<a href="noticeWriteForm.do?num=0&pageNum=1"
